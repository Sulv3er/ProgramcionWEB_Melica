...
<head>
    ...
    <title>CRUD Temas - CodeSprout</title>
    ...
    <main>
        ...
        <div> 
            ...
            <form action="../Controller/controllerHome.php" method="post">
                <input type="hidden" name="opcion" value='GUARDAR_TEMA'>
                    ...
                    <tbody >
                        <?php while($reg = $registros->fetch_assoc()){ ?>
                            <tr>
                                ...
                                <td><a class="btn btn-success" href="../Controller/controllerHome.php?opcion=EDITAR_TEMA&id=<?php echo $reg['id_tema'];?>">Editar</a></td>
                                <td><a class="btn btn-danger" href="../Controller/controllerHome.php?opcion=ELIMINAR_TEMA&id=<?php echo $reg['id_tema'];?>">Eliminar</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
